 ...
 */
    ...
    (() => {
        ...
        function getClosest(el, atr) {
            while (el && el !== document) {
                if (el.hasAttribute(atr)) return el;
                el = el.parentNode;
            }
            return null;
        }
        function useCart() {
            document.addEventListener("click", (e => {
                if (e.target.hasAttribute("data-to-cart")) {
                    const productBtn = e.target;
                    const productId = getClosest(productBtn, "data-pid").dataset.pid;
                    addToCart(productBtn, productId);
                }
                if (e.target.hasAttribute("data-cart-icon") || e.target.closest(".cart-icon")) {
                    e.preventDefault();
                    if (document.querySelector(".cart-list").children.length > 0) document.querySelector("[data-cart]").classList.toggle("_toggle-cart");
                } else if (!e.target.hasAttribute("data-cart") && !e.target.hasAttribute("data-to-cart") && !e.target.closest(".cart-list")) document.querySelector("[data-cart]").classList.remove("_toggle-cart");
                if (e.target.classList.contains("quantity-cart__plus")) {
                    const productId = e.target.closest(".cart-list__item").dataset.cartPid;
                    updateCart(e.target, productId, true);
                    e.preventDefault();
                }
                if (e.target.classList.contains("quantity-cart__minus")) {
                    const productId = e.target.closest(".cart-list__item").dataset.cartPid;
            ...
            function addToCart(productBtn, productId) {
                if (!productBtn.classList.contains("_hold")) {
                    ...
                    const productImage = product.querySelectorAll(".swiper-slide")[0];
            ...
            function updateCart(productBtn, productId, productAdd = true) {
                ...
                const cartIcon = cart.querySelector("[data-cart-icon]");
                ...
                if (productAdd) {
                    ...
                    if (!cartProduct) {
                        const product = document.querySelector(`[data-pid="${productId}"]`);
                        const cartProductImage = product.querySelectorAll(".swiper-slide")[0].innerHTML;
                        const cartProductTitle = product.querySelector('[class*="__title"]').innerHTML;
                        const cartProductPrice = product.querySelector(".content-product__price span").innerHTML;
                        const cartProductContent = `\n          <a href="#" class="cart-list__image _ibg">${cartProductImage}</a>\n          <div class="cart-list__body">\n            <a href="#" class="cart-list__title">${cartProductTitle}</a>\n            <div class="cart-list__quantity quantity-cart">\n              <div class="quantity-cart__count">Quantity: <small>1</small></div>\n              <button type="button" class="quantity-cart__plus">+</button>\n              <button type="button" class="quantity-cart__minus">-</button>\n            </div>\n            <div class="cart-list__price">Price: <span>${cartProductPrice}</span><small>₽</small></div>\n          </div>\n        `;
                        cartList.insertAdjacentHTML("beforeend", `<li data-cart-pid="${productId}" class="cart-list__item">${cartProductContent}</li>`);
                    } else {
                        const cartProductQuantity = cartProduct.querySelector(".cart-list__quantity small");
                    ...
                    if (cartQuantityValue) cartQuantity.innerHTML = cartQuantityValue; else {
                        cartQuantity.remove();
                        cart.classList.remove("_toggle-cart");
                    }
                }
            }
        }
        ...
        function initSliders() {
            if (document.querySelector(".hit__slider")) new core(".hit__slider", {
                ...
                loop: true,
                navigation: {
                    prevEl: ".hit__slider-arrow--left",
                    nextEl: ".hit__slider-arrow--right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".slider-catalog")) new core(".slider-catalog", {
                ...
                speed: 800,
                pagination: {
                    el: ".slider-catalog__dots",
                    type: "fraction",
                    clickable: false
                },
                navigation: {
                    prevEl: ".slider-catalog__arrow--prev",
                    nextEl: ".slider-catalog__arrow--next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
                ...
                on: {
                    init: function(swiper) {
                        const parent = document.querySelector(".slider-catalog__dots");
                        const nodes = parent.childNodes;
                        nodes[1].textContent = "";
                    }
                }
            });
            if (document.querySelector(".liked__slider")) new core(".liked__slider", {
                ...
                navigation: {
                    prevEl: ".liked__arrow--prev",
                    nextEl: ".liked__arrow--next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
                ...
                on: {
                    init: function(swiper) {
                        const parent = document.querySelector(".liked__dots");
                        const nodes = parent.childNodes;
                        nodes[1].textContent = "";
                    }
                }
            });
            if (document.querySelector(".recent__slider")) new core(".recent__slider", {
                modules: [ Navigation, Autoplay, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                on: {
                    init: function(swiper) {
                        const parent = document.querySelector(".recent__dots");
                        const nodes = parent.childNodes;
                        nodes[1].textContent = "";
                    }
                }
            ...
            if (document.querySelector(".thumbs__slider")) {
                const thumbsSwiper = new core(".thumbs__slider", {
        ...
        window.addEventListener("DOMContentLoaded", (function(e) {
            ...
            if (bgItems.length > 0) bgItems.forEach((bgItem => {
...
***************************************************************************** */
            ...
            galleries.forEach((gallery => {
                galleyItems.push({
                    ...
                    galleryClass: lightgallery_es5(gallery, {
                        plugins: [ lg_thumbnail_min, lg_autoplay_min ],
        ...
        window.addEventListener("DOMContentLoaded", (function() {
            ...
            function clickActions(e) {
                const targetEl = e.target;
                if (targetEl.closest(".filter__column-item>label")) targetEl.classList.toggle("_active");
                if (targetEl.closest(".filter__button")) {
                    document.querySelector(".filter__button").innerHTML = "Фильтр";
                    document.querySelector(".filter").classList.toggle("_active-filter");
                }
                if (targetEl.closest(".filter__button") && document.querySelectorAll(".filter._active-filter").length > 0) document.querySelector(".filter__button").innerHTML = "&#x2715;";
                if (targetEl.closest(".filter__column-button--reset")) {
                    document.querySelectorAll(".filter__column-item>._active").forEach((label => {
                        label.classList.remove("_active");
                    }));
                    document.querySelectorAll(".filter__column-item>input").forEach((input => {
                        if (input.checked) input.checked = !input.checked;
                    }));
                }
            }
            const columnEnd = Array.from(document.querySelectorAll(".filter__column")).at(-1);
            if (columnEnd) columnEnd.style.border = "none";
        }));
        function map() {
            console.log("ok");
            function init() {
                ...
                new ymaps.Placemark([ 59.938631, 30.323037 ], {
                    balloonContentHeader: "Хедер балуна",
                    balloonContentBody: "Тело балуна",
                    balloonContentFooter: "Футер балуна"
                }, {
                    iconLayout: "default#image",
                    iconImageHref: "https://cdn-icons-png.flaticon.com/512/5537/5537198.png",
                    iconImageSize: [ 40, 40 ],
                    iconImageOffset: [ -20, -43 ]
                });
                let placemark2 = new ymaps.Placemark([ 59.938631, 30.323037 ], {
                    balloonContent: `\n  \n        <div class="balloon">\n          <a href="" class="balloon__image">\n            <span style="color: rgb(151, 50, 50); font-weight: 500;">MAROON</span>\n            <img src="../../img/svg/star.svg" alt="star" style="width: 16px">\n            <span class="balloon__rating _icon-star-full">4.3</span>\n          </a>\n          <div class="balloon__info">\n              <a href="" class="balloon__footer">\n                  <span class="balloon__open-store">C 9:00 до 20:00</span>\n              </a>\n          </div>\n        </div>\n\n        `
                }, {
                    iconLayout: "default#image",
